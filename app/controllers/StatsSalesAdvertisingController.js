define('app/controllers/StatsSalesAdvertisingController',
    [
        'ember',
    ...
    function(Em, App, d3) {
        ...
        App.StatsSalesAdvertisingController = Em.ObjectController.extend({
          needs: ['stats'],
          ...
          chart: Em.computed(function() {
            ...
            statPackages.forEach(function(item) {
              ...
              activeUsers += item.get('activeusers').split(',').length;
        ...
        App.SalesAdvertisingChart = App.StatsChartComponent.extend({
        ...
        Em.Handlebars.helper('sales-advertising-chart', App.SalesAdvertisingChart);

        return App.StatsSalesAdvertisingController;
    }
);
