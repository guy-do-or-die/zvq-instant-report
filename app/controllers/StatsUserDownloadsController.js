define('app/controllers/StatsUserDownloadsController',
    [
        'ember',
    ...
    function(Em, App, d3) {
        ...
        App.StatsUserDownloadsController = Em.ObjectController.extend({
          needs: ['stats'],
        ...
        App.UserDownloadsChart = App.StatsChartComponent.extend({
        ...
        Em.Handlebars.helper('user-downloads-chart', App.UserDownloadsChart);

        return App.StatsUserDownloadsController;
    }
);
