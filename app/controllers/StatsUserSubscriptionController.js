define('app/controllers/StatsUserSubscriptionController',
    [
        'ember',
    ...
    function(Em, App, d3) {
        ...
        App.StatsUserSubscriptionController = Em.ObjectController.extend({
          needs: ['stats'],
        ...
        App.UserSubscriptionChart = App.StatsChartComponent.extend({
        ...
        Em.Handlebars.helper('user-subscription-chart', App.UserSubscriptionChart);

        return App.StatsUserSubscriptionController;
    }
);
