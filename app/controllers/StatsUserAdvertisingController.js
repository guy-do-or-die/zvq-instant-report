define('app/controllers/StatsUserAdvertisingController',
    [
        'ember',
    ...
    function(Em, App, d3) {
        ...
        App.StatsUserAdvertisingController = Em.ObjectController.extend({
          needs: ['stats'],
        ...
        App.UserAdvertisingChart = App.StatsChartComponent.extend({
        ...
        Em.Handlebars.helper('user-advertising-chart', App.UserAdvertisingChart);

        return App.StatsUserAdvertisingController;
    }
);
